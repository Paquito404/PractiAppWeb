...
<body>
    <div>
        <div class="header-container">
            ...
            <h1 class="texto-header">Practicas profesionales unison</h1>
        </div>
    </div>
    ...
    <nav id="navbar">
        <ul>
            ...
            <li><button onclick="loadContent('default')">Papelera</button></li>
            ...
            <li class="alinear-derecha"><button id="btnUsuario">Usuario</button></li>
        </ul>
    </nav>
