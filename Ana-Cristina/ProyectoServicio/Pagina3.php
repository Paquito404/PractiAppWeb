  ...
  <table>
        ...
        <tbody>
            <?php while ($row = sqlsrv_fetch_array($stmt, SQLSRV_FETCH_ASSOC)) : ?>
                <tr>
                    <td><?php echo "Titulo del proyecto: ".$row['Titulo']; echo "<br> Carrera: ".$row['Carrera']; echo "<br> Integrantes: ".$row['NumVac'];  ?></td>
                    <td><img src="imagen.php?id=<?= $row['ProyectoID'] ?>"  width="150" height="100" alt="ImagenProyecto"></td>
                  </tr>
            <?php endwhile; ?>
        </tbody>
    </table>
